...
def parse_user_query(user_message):
    ...
    'could', 'containing','cuisine', 'cuisines', 'currently', 'completes', 'delicious', 'did', 'directly', 'do', 'does', 
    ...
    'lately', 'like', 'looking', 'min','minutes','may', 'me', 'might', 'momentarily', 'must', 'my', 'need', 
